...
grader.addBasicPart('3-1a-0', lambda : testUCSTestCase(3),5)
...
grader.addBasicPart('3-2b-0', testDelivery,5)
...
def testHeuristic1():
    ...
    algorithm.solve(problem)
    #print(algorithm.numStatesExplored, 61)
...
def testHeuristic2():
    ...
    algorithm.solve(problem)
    #print(algorithm.numStatesExplored, 40)
...
def testHeuristic3():
    ...
    algorithm.solve(problem)
    #print(algorithm.numStatesExplored, 60, "cost:", algorithm.totalCost)
